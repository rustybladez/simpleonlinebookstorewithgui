...
public class ExploreNonFiction extends JFrame{
	public ExploreNonFiction() {
        ...
        JLabel book1 = new JLabel("1. How to Win Friends and Influence People");
        book1.setBounds(30, 20, 150, 30);
        panel.add(book1);
        
        JLabel book2 = new JLabel("2. The Art of War");
        book2.setBounds(30, 20, 150, 30);
        panel.add(book2);
        
        JLabel book3 = new JLabel("3. The Diary of a Young Girl");
        book3.setBounds(30, 20, 150, 30);
        panel.add(book3);
        
        JLabel book4 = new JLabel("4. On Liberty");
        book4.setBounds(30, 20, 150, 30);
        panel.add(book4);
        
        JLabel book5 = new JLabel("5. The Autobiography of Malcolm X");
