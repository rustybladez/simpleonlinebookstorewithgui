...
public class ExploreElectrical extends JFrame{
	public ExploreElectrical() {
        ...
        JLabel book1 = new JLabel("1. Fundamentals of Electric Circuits");
        book1.setBounds(30, 20, 150, 30);
        panel.add(book1);
        
        JLabel book2 = new JLabel("2. Fundamentals of Applied Electromagnetics");
        book2.setBounds(30, 20, 150, 30);
        panel.add(book2);
        
        JLabel book3 = new JLabel("3. Electronic Devices And Circuits: 5th Edition");
