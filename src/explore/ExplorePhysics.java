...
public class ExplorePhysics extends JFrame{
	public ExplorePhysics() {
        ...
        JLabel book1 = new JLabel("1. Fundamentals of Physics");
        book1.setBounds(30, 20, 150, 30);
        panel.add(book1);
        
        JLabel book2 = new JLabel("2. University Physics");
        book2.setBounds(30, 20, 150, 30);
        panel.add(book2);
        
        JLabel book3 = new JLabel("<html>" + "3. Introduction to Classical Mechanics: With Problems and Solutions" + "</html>");
