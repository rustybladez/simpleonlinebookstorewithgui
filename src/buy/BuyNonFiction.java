...
public class BuyNonFiction extends JFrame{
    ...
    public BuyNonFiction() {
        ...
        String[] bookNames = {"<html>" + "1. How to Win Friends and Influence People" + "</html>",
        		"<html>" + "2. The Art of War" + "</html>",
        		"<html>" + "3. The Diary of a Young Girl" + "</html>",
        		"<html>" + "4. On Liberty" + "</html>",
        		"<html>" + "5. The Autobiography of Malcolm X" + "</html>"};
        ...
        goBackButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                BuyNonAcademicBooksWindow buyNonAcademic = new BuyNonAcademicBooksWindow();
                buyNonAcademic.setVisible(true);  // show the BuyAcademicBooksWindow window
            }
        });
