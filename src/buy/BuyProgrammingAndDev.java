...
public class BuyProgrammingAndDev extends JFrame{
    ...
    public BuyProgrammingAndDev() {
        ...
        String[] bookNames = {"<html>" + "1. The C Programming Language: 2nd Edition" + "</html>",
        		"<html>" + "2. The C++ Programming Language: 4th Edition" + "</html>",
        		"<html>" + "3. Effective Java: 2nd Edition" + "</html>",
        		"<html>" + "4. Clean Code: A Handbook of Agile Software Craftsmanship" + "</html>",
        		"<html>" + "5. The Pragmatic Programmer: 20th Anniversary Edition" + "</html>"};
