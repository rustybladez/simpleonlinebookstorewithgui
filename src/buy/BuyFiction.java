...
public class BuyFiction extends JFrame{
    ...
    public BuyFiction() {
        ...
        String[] bookNames = {"<html>" + "1. War and Peace" + "</html>",
        		"<html>" + "2. The Great Gatsby" + "</html>",
        		"<html>" + "3. A Tale of Two Cities" + "</html>",
        		"<html>" + "4. Pride and Prejudice" + "</html>",
        		"<html>" + "5. Huckleberry Finn" + "</html>"};
