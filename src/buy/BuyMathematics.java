...
public class BuyMathematics extends JFrame{
    ...
    public BuyMathematics() {
        ...
        String[] bookNames = {"<html>" + "1. Calculus Made Easy" + "</html>",
        		"<html>" + "2. Mathematics: From the Birth of Numbers" + "</html>",
        		"<html>" + "3. Introduction to Mathematical Thinking" + "</html>"};
