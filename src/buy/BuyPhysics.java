...
public class BuyPhysics extends JFrame{
    ...
    public BuyPhysics() {
        ...
        String[] bookNames = {"<html>" + "1. Fundamentals of Physics" + "</html>",
        		"<html>" + "2. University Physics" + "</html>",
        		"<html>" + "3. Introduction to Classical Mechanics: With Problems and Solutions" + "</html>"};
