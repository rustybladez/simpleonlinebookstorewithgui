...
import buy.BuyAcademicBooksWindow;

public class RentProgrammingAndDev extends JFrame{
    ...
    public RentProgrammingAndDev() {
        ...
        String[] bookNames = {"1. The C Programming Language: 2nd Edition",
